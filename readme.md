...
5. G. Lemaitre, R. Marti, J. Freixenet, J. C. Vilanova, P. M. Walker, and F. Meriaudeau, "Computer-aided detection and diagnosis for prostate cancer based on mono and multi-parametric MRI: A review", _Comput. Biol. Med._, vol. 60, pp. 8–31, 2015.
...
10. The PyTorch implementation of "Vector Quantized Diffusion Model for Text-to-Image Synthesis" (VQ-Diffusion): https://github.com/cientgu/VQ-Diffusion.
